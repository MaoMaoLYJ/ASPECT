...
problem solving using reinforcement learning with strategy proposal.
...
def main(config):
    ...
    load_validation_dataset = getattr(config.rllm, "load_validation_dataset", True)
    test_dataset = (
        DatasetRegistry.load_dataset("aime2025", "test")
