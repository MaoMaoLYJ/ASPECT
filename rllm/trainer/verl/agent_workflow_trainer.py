...
class AgentWorkflowPPOTrainer(RayPPOTrainer):
    def __init__(
        ...
        if self.config.rllm.get("distill", {}).get("enable", False):
            raise ValueError("Distillation is not part of this runtime")
    ...
    def _validate_agent(self):
        ...
        for test_data in self.val_dataloader:
            ...
            if online_enabled:
                from rllm.trainer.verl.inline_full_validation import write_record
